...
ALTER TABLE guests ALTER COLUMN id RESTART WITH 4;
ALTER TABLE guest_profiles ALTER COLUMN id RESTART WITH 4;
ALTER TABLE rooms ALTER COLUMN id RESTART WITH 7;
